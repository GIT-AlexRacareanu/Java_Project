public class Rectangle extends Shape implements Polygon
{
    ...
    public String toString(){
        return "This is a " + this.getClass().getName() + ", it's name is " + this.name +" and it has " +  numberOfSides + " sides, two of  " +length+ " centimeters, and two of  " + this.width + " centimeters";
    }
}
